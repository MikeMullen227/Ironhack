...
for(var index = 0, length = array_words.length; index < length; index++){
	array_words[index] = array_words[index].length;
	
}

array_words.sort();
return array_words[index-1]
...
function calculateAverage( array ){
	var sum = 0
	for( var index = 0, length = array_lengths.length ; index < length; index++){
	sum += array_lengths[index]
	}
	var average = sum / array_lengths.length
